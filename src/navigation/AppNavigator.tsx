...
// Main Screens
import { CreateMomentScreen } from '../screens/main/CreateMomentScreen';
import { GiveJoyScreen } from '../screens/main/GiveJoyScreen';
import { YourMomentsScreen } from '../screens/main/YourMomentsScreen';
import { WallOfJoyScreen } from '../screens/main/WallOfJoyScreen';
...
const MainTabNavigator: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen 
        name="YourMoments" 
        component={YourMomentsScreen}
        options={{ title: 'Your Moments' }}
      />
      <Tab.Screen 
        name="WallOfJoy" 
        component={WallOfJoyScreen}
        options={{ title: 'Wall of Joy' }}
      />
    </Tab.Navigator>
  );
...
export const AppNavigator: React.FC = () => {
  const theme = useTheme();
  const { isAuthenticated, user, isLoading } = useAuth();
  const { activeCall, incomingCall, callStatus } = useCall();
  ...
  if (callStatus === 'completed' && activeCall) {
    return <ReviewScreen />;
  }
  ...
  // Show active call screen if there's an active call
  if (activeCall) {
    return <CallScreen />;
  }
